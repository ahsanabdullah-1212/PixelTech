    ...
    <div class="main-service-hero-section">
        <div class="hero-details">
            <div class="service-hero-texting">
                <h1 class="hero-text">Our <span class="animated">Team</span></h1>
            </div>
            <div class="hero-stars">
                ...
                <div class="hero-paragraph">
                    <p>Our team delivers top-quality results across six core areas. Not sure where your project fits?
                        Reach out—we’re here to help.</p>
                </div>
            </div>
        </div>
    </div>
