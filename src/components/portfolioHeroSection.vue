        ...
        <div class="hero-details">
            ...
            <div class="hero-stars">
                ...
                <div class="hero-paragraph">
                    <p>This is the page we’re most proud of. If you’d like more details on a specific project, want to
                        know more about the thinking behind a design decision, or just want to tell us we’re awesome,
                        get in touch.</p>
                </div>
            </div>
        </div>
